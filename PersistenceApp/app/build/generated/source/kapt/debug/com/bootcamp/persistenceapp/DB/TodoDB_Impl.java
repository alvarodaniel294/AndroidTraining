...
import com.bootcamp.persistenceapp.dao.TodoDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Todo` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `value_db` TEXT NOT NULL, `states` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'fe83aaddaa08c0684c19b10086467fcb')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsTodo.put("value_db", new TableInfo.Column("value_db", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTodo.put("states", new TableInfo.Column("states", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoTodo.equals(_existingTodo)) {
          return new RoomOpenHelper.ValidationResult(false, "Todo(com.bootcamp.persistenceapp.entities.Todo).\n"
                  + " Expected:\n" + _infoTodo + "\n"
                  + " Found:\n" + _existingTodo);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "fe83aaddaa08c0684c19b10086467fcb", "435950d617e85db7633f9c8e464adc3c");
